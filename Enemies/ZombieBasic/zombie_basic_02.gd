...
func set_max_health(zombie_base_health: int):
	...
	"""
	head_health.max_health = zombie_base_health * 1.5
	head_health.fill_health()
	left_upper_health.max_health = zombie_base_health * .5
	left_upper_health.fill_health()
	right_upper_health.max_health = zombie_base_health * .5
	right_upper_health.fill_health()
	left_lower_health.max_health = zombie_base_health * .25
	left_lower_health.fill_health()
	right_lower_health.max_health = zombie_base_health * .25
