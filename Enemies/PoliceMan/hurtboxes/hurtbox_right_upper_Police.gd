...
@onready var right_upper_polygon: Polygon2D = %armRightUpperPolygon
@onready var right_lower_hitbox: Area2D = %HurtBoxRightLower
@onready var right_lower_collision: CollisionShape2D = %rightLowerCollision
@onready var collision_shape: CollisionShape2D = $CollisionShape2D

@onready var lower_arm_body_part = preload("res://VFX/Gore/rigidBodyParts_Police/Police - BodyPart-ArmLower.tscn")
@onready var upper_arm_body_part = preload("res://VFX/Gore/rigidBodyParts_Police/Police - BodyPart-ArmRightUpper.tscn")
...
func death_effect():
	...
	right_lower_collision.set_deferred("disabled", true)
